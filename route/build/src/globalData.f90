module globalData
  ...
  real(dp)                       , public :: subfshape                  ! shape parameter in subsurface time delay histogram (=gamma distribution) [-]
  real(dp)                       , public :: subtscale                  ! scaling factor for the subsurface time delay histogram [sec]  
  ...
  REAL(DP)        , ALLOCATABLE  , public :: FRAC_FUTURE_SUB(:)   ! fraction of subsurface runoff in future time steps
  ...
  TYPE(STRFLX)    , allocatable  , public :: RCHFLX_SUB(:,:)          ! Reach fluxes (ensembles, space [reaches]) for entire river network  
