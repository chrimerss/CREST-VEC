module public_var
  ...
  real(dp),    parameter,public   :: subrunoffMin=1.e-15_dp    ! minimum runoff from each basin
  ...
  character(len=strLen),public    :: vname_subqsim        = ''              ! variable name for simulated subsurface runoff
